...
if (-not $NoGuest) {
    ...
    if ($GuestCc -and (Get-Command $GuestCc -ErrorAction SilentlyContinue)) {
        ...
        $guestSources = @(
            ...
            @{ src = "tools\guests\demos\demo_nmibody.c"; sym = "demo_nmibody_elf"; out = "demo_nmibody.elf"; gen = "demo_nmibody_elf_data.c"; extra = $mgGuestImpls }
        )
