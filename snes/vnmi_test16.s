...
TOP_LB        = 16               ; top letterbox lines
BOT_LB        = 16               ; bottom letterbox lines
...
; 9 bands × 32 tiles = 288 tiles (9216 B). Band B uses palette index
; (B+1); band 8 = idx 9 = ORANGE = the burst TAIL marker for this
; 9216 B / FB(16,16) test (white is now band 7, mid-burst).
chr_data:
    band $FF, $00, $00, $00     ; band 0: idx 1  red
    band $00, $FF, $00, $00     ; band 1: idx 2  green
    band $FF, $FF, $00, $00     ; band 2: idx 3  yellow
    band $00, $00, $FF, $00     ; band 3: idx 4  blue
    band $FF, $00, $FF, $00     ; band 4: idx 5  cyan
    band $00, $FF, $FF, $00     ; band 5: idx 6  magenta
    band $FF, $FF, $FF, $00     ; band 6: idx 7  grey
    band $00, $00, $00, $FF     ; band 7: idx 8  white
    band $FF, $00, $00, $FF     ; band 8: idx 9  ORANGE (burst TAIL marker)
